        ...
        .then(user=>{
            ...
            user.save().then((result)=>{
                transporter.sendMail({
                    to:user.email,
                    from:"Clientron <hello@clientronapp.com>",
                    subject:"Password reset request",
                    html:`
                    <p>You requested for password reset from Arc Invoicing application</p>
                    <h5>Please click this <a href="https://clientronapp.com/reset/${token}">link</a> to reset your password</h5>
                    <p>Link not clickable?, copy and paste the following url in your address bar.</p>
                    <p>https://clientronapp.com/reset/${token}</p>
